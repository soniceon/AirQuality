...
export default function Science() {
  ...
  return (
    <>
      <Helmet>
        <title>{t('science.seoTitle', t('science.title'))}</title>
        <meta name="description" content={t('science.seoDesc', t('science.title'))} />
        <meta name="keywords" content={t('science.seoKeywords', 'science, air quality, article, AQI, PM2.5')} />
        <meta property="og:title" content={t('science.seoTitle', t('science.title'))} />
        <meta property="og:description" content={t('science.seoDesc', t('science.title'))} />
        <meta property="og:type" content="article" />
        <meta property="og:url" content={typeof window !== 'undefined' ? window.location.href : ''} />
        <meta property="og:image" content="https://airquality.tools/og-image.png" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={t('science.seoTitle', t('science.title'))} />
        <meta name="twitter:description" content={t('science.seoDesc', t('science.title'))} />
        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          "@type": "Article",
          "headline": t('science.seoTitle', t('science.title')),
          "description": t('science.seoDesc', t('science.title')),
