...
export default function Contact() {
  ...
  return (
    <>
      <Helmet>
        <title>{t('contact.seoTitle', t('contact.title'))}</title>
        <meta name="description" content={t('contact.seoDesc', t('contact.title'))} />
        <meta name="keywords" content={t('contact.seoKeywords', 'contact, air quality, email, phone, AQI')} />
        <meta property="og:title" content={t('contact.seoTitle', t('contact.title'))} />
        <meta property="og:description" content={t('contact.seoDesc', t('contact.title'))} />
        ...
        <meta name="twitter:title" content={t('contact.seoTitle', t('contact.title'))} />
        <meta name="twitter:description" content={t('contact.seoDesc', t('contact.title'))} />
        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          "@type": "ContactPage",
          "name": t('contact.seoTitle', t('contact.title')),
          "description": t('contact.seoDesc', t('contact.title')),
