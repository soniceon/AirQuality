  ...
  return (
    <div className="relative inline-block align-middle" style={{ minWidth: 0 }}>
      <Listbox value={currentLang} onChange={changeLanguage}>
        ...
        <Listbox.Options className="absolute z-10 mt-1 bg-white border border-gray-200 rounded-lg shadow-lg focus:outline-none" style={{ width: '100%', left: 0, minWidth: 0, maxWidth: '100%', maxHeight: 'none', overflow: 'visible' }}>
